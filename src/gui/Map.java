...
public class Map extends JFrame  {
    ...
    /** 玩家图片 */
    private Image player1 = ImageIO.read(new File("src/image/character.png"));
    private Image player2 = ImageIO.read(new File("src/image/soldier.png"));
    private Image player3 = ImageIO.read(new File("src/image/barbarian.png"));
    /** 宝箱图片 */
    private Image treasure = ImageIO.read(new File("src/image/treasure.png"));
    /** 龙图片 */
    private Image dragon = ImageIO.read(new File("src/image/dragon.png"));
    /** 狼图片 */
    private Image wolf = ImageIO.read(new File("src/image/wolf.png"));
    /** 熊图片（1） */
    private Image bear1 = ImageIO.read(new File("src/image/bear(1).png"));
    /** 熊图片（2）*/
    private Image bear2 = ImageIO.read(new File("src/image/bear(2).png"));
    /** 虎图片*/
    private Image tiger = ImageIO.read(new File("src/image/tiger.png"));
    /** 蛇图片（1）*/
    private Image snake1 = ImageIO.read(new File("src/image/snake(1).png"));
    /** 蛇图片（2）*/
    private Image snake2 = ImageIO.read(new File("src/image/snake(2).png"));
    /** 狐狸图片（1）*/
    private Image fox1 = ImageIO.read(new File("src/image/fox(1).png"));
    /** 狐狸图片（2）*/
    private Image fox2 = ImageIO.read(new File("src/image/fox(2).png"));
    /** 狐狸图片（3）*/
    private Image fox3 = ImageIO.read(new File("src/image/fox(3).png"));
    /** 地形图片 */
    private Image image1 = ImageIO.read(new File("src/image/grass.png"));
    private Image image2 = ImageIO.read(new File("src/image/forest.png"));
    private Image image3 = ImageIO.read(new File("src/image/bridge.png"));
    private Image image4 = ImageIO.read(new File("src/image/river.png"));
    private Image image5 = ImageIO.read(new File("src/image/mountain.png"));
    private Image image6 = ImageIO.read(new File("src/image/marshland.png"));
