...
public class EntityLoader {
    ...
    public static List<Bear> loadBears(int count) throws IOException {
        ...
        Image image = ImageIO.read(new File("C:/Users/yingb/Desktop/CY-L3II/InterProjet-Explorateur/PDI_Github/PDI/src/image/bear(1).png"));
    ...
    public static List<Fox> loadFoxes(int count) throws IOException {
        ...
        Image image = ImageIO.read(new File("C:/Users/yingb/Desktop/CY-L3II/InterProjet-Explorateur/PDI_Github/PDI/src/image/fox(1).png"));
        for (int i = 0; i < count; i++) {
            Point position = new Point((int) (Math.random() * 20), (int) (Math.random() * 20));
    ...
    public static List<Tiger> loadTigers(int count) throws IOException {
        ...
        Image image = ImageIO.read(new File("C:/Users/yingb/Desktop/CY-L3II/InterProjet-Explorateur/PDI_Github/PDI/src/image/tiger.png"));
        for (int i = 0; i < count; i++) {
            Point position = new Point((int) (Math.random() * 20), (int) (Math.random() * 20));
    ...
    public static Dragon loadDragon() throws IOException {
        Image image = ImageIO.read(new File("C:/Users/yingb/Desktop/CY-L3II/InterProjet-Explorateur/PDI_Github/PDI/src/image/dragon.png"));
